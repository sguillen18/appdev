...
$sql = 'SELECT * FROM Reservation_t WHERE Park_Id = 2';
...
<!-- 		<h1>Park Name Here<h1> -->
  ...
  <tbody>
	...
	<!--Google Maps Directions-->
		<div>
			<a class="button" href="https://www.google.com/maps/dir//Joe+Moakley+Park,+Columbia+Rd,+Boston,+MA/@42.3256604,-71.1199125,12z/data=!4m8!4m7!1m0!1m5!1m1!1s0x89e37af61fc7c3f3:0xc532af20cba8c575!2m2!1d-71.0498714!2d42.3256817">Directions</a>
		</div>
	</body>	
...
function getValues(){
    ...
    xmlhttp.open("GET", "insert.php?name="+name+"&date=" + date + "&time=" + time + "&people=" + number_of_people + "&notes=" + notes, false);
    xmlhttp.send(null);
